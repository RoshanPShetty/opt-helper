...
const COUNTDOWN_FROM = "2024-09-09";
...
const Countdown = () => {
	return (
		...
		>
			...
			<h2 className="font-serif text-3xl md:text-5xl lg:text-6xl text-center my-6">
				Days till release
			</h2>
			<p className="text-center md:text-lg lg:text-xl mt-4 mb-8 max-w-md mx-auto">
				Revolutionize your OPT experience in September 2024.
			</p>
			<div className="mx-auto flex w-full max-w-5xl items-center bg-black rounded-2xl text-white">
...
const CountdownItem = ({ unit, text }: { unit: string; text: string }) => {
	...
	return (
		<div className="flex h-24 w-1/4 flex-col items-center justify-center gap-1 border-r-[1px] border-slate-200 font-mono md:h-36 md:gap-2 rounded-r-2xl">
